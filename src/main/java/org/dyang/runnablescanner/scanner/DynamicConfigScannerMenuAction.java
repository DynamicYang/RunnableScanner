...
public class DynamicConfigScannerMenuAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        String parentActionId = "DynamicConfigScannerMenuAction";
        DefaultActionGroup parentGroup = (DefaultActionGroup) actionManager.getAction(parentActionId);
        ...
        for (ConfigScanner scanner : scanners) {
            ...
            parentGroup.add(menuItemAction);
        }
